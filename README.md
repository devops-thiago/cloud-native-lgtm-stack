...
A complete, lightweight, cloud-native observability stack optimized for single-node Kubernetes environments like Minikube. Perfect for hands-on labs and local development.
